...
urlpatterns = [
    ...
    path("match/admin-disconnect/<int:user_id>/", views.admin_disconnect_match, name="admin_disconnect_match"),
    ...
    path("master/user/<int:user_id>/chats/", views.admin_user_chats, name="admin_user_chats"),
    path("master/user/<int:user_id>/chats/<int:partner_id>/", views.admin_chat_detail, name="admin_chat_detail"),
    ...
    path("community/<slug:slug>/info/", views.community_info, name="community_info"),
    path("api/communities/list/", views.community_list_api, name="community_list_api"),
    path("api/community/<slug:slug>/join/", views.community_join, name="community_join"),
    path("api/community/<slug:slug>/leave/", views.community_leave, name="community_leave"),
    path("api/community/<slug:slug>/toggle-mute/", views.community_toggle_mute, name="community_toggle_mute"),
